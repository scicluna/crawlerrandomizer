...
def get_ai_json(crawler_name:str, crawler_class: str, crawler_level: int, crawler_stats, item_types: list, ai_detailed: str) -> dict[str, any]:
    """
    ...
    prompt = generate_ai_prompt(crawler_name, crawler_class, crawler_level, crawler_stats, item_types)
...
def generate_ai_prompt(crawler_name: str, crawler_class: str, crawler_level: int, crawler_stats, item_types: list):
